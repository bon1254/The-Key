...
public class DialogueSystemWeapon : MonoBehaviour
{
    ...
    public bool ForWeaponCheck = true;
    ...
    void Update()
    {       
        if (Input.GetKeyDown(KeyCode.E) && InWeapon == true)
        {
            ForWeaponCheck = false;
            InWeapon = false;
            StartDialogue();
        ...
        if (Input.GetMouseButtonDown(0) && IsTalking == true && ForWeaponCheck == false)  //按下左鍵+對話開啟
        {
