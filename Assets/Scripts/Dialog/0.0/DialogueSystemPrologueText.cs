...
public class DialogueSystemPrologueText : MonoBehaviour
{
    ...
    public bool ForTextCheck = false;
    ...
    void Update()
    {       
        if (Input.GetKeyDown(KeyCode.E) && InText == true)
        {
            ForTextCheck = false;
            InText = false;
            StartDialogue4();
        ...
        if (Input.GetMouseButtonDown(0) && IsTalking == true && ForTextCheck == false)  //按下左鍵+對話開啟
        {
