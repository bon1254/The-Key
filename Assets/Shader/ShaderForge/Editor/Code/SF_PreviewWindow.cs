...
namespace ShaderForge
{
    ...
    public class SF_PreviewWindow
    {
        ...
        public void SetupPreview()
        {
            ...
            cam.cullingMask = (int)Mathf.Pow(2, LayerMask.NameToLayer("SF_EditorPreview"));
        ...
        public void DrawMesh(RenderTexture overrideRT = null, Material overrideMaterial = null, bool sphere = false)
        {
            ...
            {
                Graphics.DrawMesh(drawMesh, Quaternion.identity * pos, Quaternion.identity, mat, LayerMask.NameToLayer("SF_EditorPreview"), cam, i);
            }
